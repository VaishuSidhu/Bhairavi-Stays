        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div className="space-y-10 group">
            ...
            <div className="space-y-6">
              {[
                { icon: Phone, title: 'Phone Enquiry', value: '+91 97918 81222', desc: 'Call us daily 6 AM to 10 PM' },
                { icon: MessageSquare, title: 'WhatsApp Chat', value: '+91 97918 81222', desc: 'Instant support for bookings' },
