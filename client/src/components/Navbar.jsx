...
import { Menu, X, Home, Info, Bed, Settings, MapPin, Phone, HelpCircle, Calendar as CalendarIcon } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Availability', href: '/calendar', icon: CalendarIcon },
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <Link 
                to="/contact" 
                className="bg-gold text-kaavi px-8 py-3 rounded-full font-black text-xs uppercase tracking-widest hover:bg-darkkaavi hover:text-white transition-all duration-300 shadow-2xl transform hover:scale-110 active:scale-95"
              >
                Book Now
              </Link>
            </div>
